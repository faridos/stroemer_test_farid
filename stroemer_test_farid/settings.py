"""
Django settings for stroemer_test_farid project.
...
SECRET_KEY = 'django-secure-(lk5!gok_04=!88=!2f7-t22*zxxt-=-r$5kdt*g(_g(9*kpda'
...
ROOT_URLCONF = 'stroemer_test_farid.urls'
...
WSGI_APPLICATION = 'stroemer_test_farid.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'myauth.authentication.custom_auth.FakeUserAuthentication',
    ],
}
